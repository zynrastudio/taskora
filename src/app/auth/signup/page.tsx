...
import { CheckCircleIcon, EyeIcon, EyeSlashIcon, UserIcon } from '@heroicons/react/24/outline'
        ...
        <div className="bg-background py-8 px-4 shadow-xl rounded-lg sm:px-10 border border-border hover:shadow-2xl transition-all duration-300">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <Input
                  ...
                  className="pl-10 transition-all duration-200 focus:scale-[1.01] hover:border-primary/50"
                />
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="accept-terms" className="ml-2 block text-sm text-muted-foreground hover:text-foreground transition-colors cursor-pointer">
                I agree to the{' '}
